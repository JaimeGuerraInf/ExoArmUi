...
class ExerciseSimulator:
    def __init__(self):
        ...
        # Secuencia de Escalas Musicales (Do mayor ascendente y descendente)
        self.sequence = [
            # Escala ascendente
            {"note": "C", "angle": 30, "duration": 1.0},   # Do
            {"note": "D", "angle": 45, "duration": 1.0},   # Re
            {"note": "E", "angle": 60, "duration": 1.0},   # Mi
            {"note": "F", "angle": 75, "duration": 1.0},   # Fa
            {"note": "G", "angle": 90, "duration": 1.0},   # Sol
            {"note": "A", "angle": 105, "duration": 1.0},  # La
            {"note": "B", "angle": 120, "duration": 1.0},  # Si
            {"note": "C2", "angle": 135, "duration": 2.0}, # Do (octava superior)
            # Pequeña pausa
            {"note": "C2", "angle": 135, "duration": 0.5}, # Pausa
            # Escala descendente
            {"note": "B", "angle": 120, "duration": 1.0},  # Si
            {"note": "A", "angle": 105, "duration": 1.0},  # La
            {"note": "G", "angle": 90, "duration": 1.0},   # Sol
            ...
            {"note": "E", "angle": 60, "duration": 1.0},   # Mi
            {"note": "D", "angle": 45, "duration": 1.0},   # Re
            {"note": "C", "angle": 30, "duration": 2.0}    # Do
        ]
    ...
    def run_exercise(self):
        try:
            rospy.loginfo("🎵 Iniciando simulación de Escalas Musicales")
